...
class PursueGenerator extends AbstractGenerator {

	override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
		fsa.generateFile('output_model.xml', SDLtoUPPAAL(resource.contents.head as Model))
		fsa.generateFile('output_model.q', SDLtoQ(resource.contents.head as Model))
	}
