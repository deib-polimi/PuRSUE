 ...
 * </p>
 * <ul>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#getName <em>Name</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#getFirst_ev <em>First ev</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#isIs_seq1 <em>Is seq1</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#getFirst_seq <em>First seq</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#isThen <em>Then</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#isOr <em>Or</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#getSecond_ev <em>Second ev</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#isIs_seq2 <em>Is seq2</em>}</li>
 *   <li>{@link se.cth.pursue.impl.RegolaImpl#getSecond_seq <em>Second seq</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegolaImpl extends MinimalEObjectImpl.Container implements Regola
{
  ...
  {
    return PursuePackage.Literals.REGOLA;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__NAME, oldName, name));
  }
  ...
  public Event getFirst_ev()
  {
    if (first_ev != null && first_ev.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PursuePackage.REGOLA__FIRST_EV, oldFirst_ev, first_ev));
      }
    }
    return first_ev;
  }
  ...
  public void setFirst_ev(Event newFirst_ev)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__FIRST_EV, oldFirst_ev, first_ev));
  }
  ...
  public void setIs_seq1(boolean newIs_seq1)
  {
    ...
    is_seq1 = newIs_seq1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__IS_SEQ1, oldIs_seq1, is_seq1));
  }
  ...
  public NotificationChain basicSetFirst_seq(Sequence newFirst_seq, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__FIRST_SEQ, oldFirst_seq, newFirst_seq);
  ...
  public void setFirst_seq(Sequence newFirst_seq)
  {
    if (newFirst_seq != first_seq)
    {
      ...
      if (first_seq != null)
        msgs = ((InternalEObject)first_seq).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PursuePackage.REGOLA__FIRST_SEQ, null, msgs);
      if (newFirst_seq != null)
        msgs = ((InternalEObject)newFirst_seq).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PursuePackage.REGOLA__FIRST_SEQ, null, msgs);
      msgs = basicSetFirst_seq(newFirst_seq, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__FIRST_SEQ, newFirst_seq, newFirst_seq));
  }
  ...
  public void setThen(boolean newThen)
  {
    ...
    then = newThen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__THEN, oldThen, then));
  }
  ...
  public void setOr(boolean newOr)
  {
    ...
    or = newOr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__OR, oldOr, or));
  }
  ...
  public Event getSecond_ev()
  {
    if (second_ev != null && second_ev.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PursuePackage.REGOLA__SECOND_EV, oldSecond_ev, second_ev));
      }
    }
    return second_ev;
  }
  ...
  public void setSecond_ev(Event newSecond_ev)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__SECOND_EV, oldSecond_ev, second_ev));
  }
  ...
  public void setIs_seq2(boolean newIs_seq2)
  {
    ...
    is_seq2 = newIs_seq2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__IS_SEQ2, oldIs_seq2, is_seq2));
  }
  ...
  public NotificationChain basicSetSecond_seq(Sequence newSecond_seq, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__SECOND_SEQ, oldSecond_seq, newSecond_seq);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSecond_seq(Sequence newSecond_seq)
  {
    if (newSecond_seq != second_seq)
    {
      NotificationChain msgs = null;
      if (second_seq != null)
        msgs = ((InternalEObject)second_seq).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PursuePackage.REGOLA__SECOND_SEQ, null, msgs);
      if (newSecond_seq != null)
        msgs = ((InternalEObject)newSecond_seq).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PursuePackage.REGOLA__SECOND_SEQ, null, msgs);
      msgs = basicSetSecond_seq(newSecond_seq, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PursuePackage.REGOLA__SECOND_SEQ, newSecond_seq, newSecond_seq));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PursuePackage.REGOLA__FIRST_SEQ:
        return basicSetFirst_seq(null, msgs);
      case PursuePackage.REGOLA__SECOND_SEQ:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PursuePackage.REGOLA__NAME:
        return getName();
      case PursuePackage.REGOLA__FIRST_EV:
        if (resolve) return getFirst_ev();
        return basicGetFirst_ev();
      case PursuePackage.REGOLA__IS_SEQ1:
        return isIs_seq1();
      case PursuePackage.REGOLA__FIRST_SEQ:
        return getFirst_seq();
      case PursuePackage.REGOLA__THEN:
        return isThen();
      case PursuePackage.REGOLA__OR:
        return isOr();
      case PursuePackage.REGOLA__SECOND_EV:
        if (resolve) return getSecond_ev();
        return basicGetSecond_ev();
      case PursuePackage.REGOLA__IS_SEQ2:
        return isIs_seq2();
      case PursuePackage.REGOLA__SECOND_SEQ:
