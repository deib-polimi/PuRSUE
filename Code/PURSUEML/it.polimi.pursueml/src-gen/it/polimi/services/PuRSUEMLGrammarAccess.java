...
@Singleton
public class PuRSUEMLGrammarAccess extends AbstractGrammarElementFinder {
	
	public class PuRSUEMLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.PuRSUEML");
	...
	public class PdiElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Pdi");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConnectionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.connection");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EventElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Event");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RegolaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Regola");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SequenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Sequence");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StatoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Stato");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StateDepElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.StateDep");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AgentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Agent");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ObjectiveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.Objective");
	...
	public class ReachObjectiveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.PuRSUEML.ReachObjective");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final PuRSUEMLElements pPuRSUEML;
	...
	@Inject
	public PuRSUEMLGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pPuRSUEML = new PuRSUEMLElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("it.polimi.PuRSUEML".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	agents+=Agent* (have_obj?='objective:' objective=Objective)? (have_reach_obj?='reach_objective:'
	//	reachobjective=ReachObjective)?;
	public PuRSUEMLElements getPuRSUEMLAccess() {
		return pPuRSUEML;
	}
	
	public ParserRule getPuRSUEMLRule() {
		return getPuRSUEMLAccess().getRule();
	}
