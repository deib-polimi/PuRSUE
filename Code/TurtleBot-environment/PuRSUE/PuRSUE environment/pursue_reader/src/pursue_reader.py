...
class Reader:
  ...
  def callback(self, data):
		...
		if (input[31]== 'c'):
			f=open("/home/co4robots/Desktop/received_components/runtime_controller.py", "w+")
			f.write(input)		
			print("file created in"+f.name)
			f.close()
			f=open("/home/co4robots/turtlebot/src/pursue_controller_node/src/runtime_controller.py", "w+")
			f.write(input)		
			print("file created in"+f.name)
			f.close()
		if (input[31]== 'o'):
			...
			print("file created in"+f.name)
			f.close()
			f=open("/home/co4robots/turtlebot/src/pursue_observer_node/src/observer.py", "w+")
			f.write(input)		
			print("file created in"+f.name)
			f.close()
